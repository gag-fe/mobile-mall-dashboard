(function () {
  ...
  k.prototype = {
    Aa: function () {
      ...
      try {
        if ("undefined" === typeof e._cz_account || e._cz_account === this.c) {
          ...
          if ("[object Array]" === {}.toString.call(e._czc))for (var a = e._czc, b = 0,
      ...
      try {
        ...
        this.a.b = {};
        if (a)for (var d = a.split("&"),
                     a = 0; a < d.length; a++)c = m(d[a]), b = c.split("|"), this.a.b[m(b[0])] = {}, this.a.b[m(b[0])].da = m(b[1]), this.a.b[m(b[0])].h = m(b[2])
      } catch (l) {
        g(l, "gCV failed")
      }
    }, ka: function () {
    ...
    m: function (a) {
      ...
      for (var a = e.navigator.userAgent.toLowerCase(),
             b = 0; 12 > b; b++)if (-1 < a.indexOf("#mobileconf#"[b]))return "mobile";
      return "pc"
    }
  };
  try {
